...
def test_event_recorded_after_ledger_freeze_is_structural_failure() -> None:
    ...
    event_document["recorded_at"] = "2026-08-03T19:57:39Z"
    ...
    corpus_document[f"{revocation_fx.PREFIX}_ledger_ref"] = (
    ...
    with pytest.raises(
        ...
        validate_checkpoint_witness_conflict_adjudicator_credential_revocation_ledger(
            ...
            evaluated_at="2026-08-03T19:57:40Z",
        )
...
def test_evaluation_before_successor_publication_is_structural_failure() -> None:
    with pytest.raises(
        ...
        revocation_fx.validate(evaluated_at="2026-08-03T19:57:37Z")
